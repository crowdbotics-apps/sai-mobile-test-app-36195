...
## Project Structure
    ...
    ├── sai_mobile_test_app_36195  # Django project configurations
...
1. Clone this repo and `cd sai_mobile_test_app_36195`
...
2. Clone this repo and `cd sai_mobile_test_app_36195`
